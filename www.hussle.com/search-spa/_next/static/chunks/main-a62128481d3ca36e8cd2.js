    ...
    [15], {
        ...
        IKlv: function(e, t, r) {
            ...
            var L = function(e) {
                ...
                V = k.defaultLocale,
                z = B || "";
            r.p = "".concat(z, "/_next/"), _.setConfig({
                serverRuntimeConfig: {},
                publicRuntimeConfig: j || {}
            });
            var K = (0, x.getURL)();
            (0, E.hasBasePath)(K) && (K = (0, E.delBasePath)(K));
            var Y = new A.default(q, z),
                J = function(e) {
                    var t = l(e, 2),
                        r = t[0],
                        n = t[1];
            ...
            var ne, ae = function(e) {
                    ...
                    return i(r, [{
                        ...
                        value: function() {
                            this.scrollToHash(), !Z.isSsr || "/404" === I || "/_error" === I && M && M.pageProps && 404 === M.pageProps.statusCode || !(H || k.nextExport && ((0, b.isDynamicRoute)(Z.pathname) || location.search) || M && M.__N_SSG && location.search) || Z.replace(Z.pathname + "?" + String(w.assign(w.urlQueryToSearchParams(Z.query), new URLSearchParams(location.search))), K, {
                                _h: 1,
                                shallow: !H
                            })
                        }
                ...
                var e = a(n.mark((function e() {
                    ...
                    return n.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return s.length > 0 && void 0 !== s[0] ? s[0] : {}, r = F, e.prev = 3, e.next = 6, Y.routeLoader.whenEntrypoint("/_app");
                            case 6:
                                ...
                                throw a.error;
                            case 9:
                                o = a.component, i = a.exports, $ = o, i && i.reportWebVitals && (ee = function(e) {
                                    var t, r = e.id,
                                        n = e.name,
                                        a = e.startTime,
                                        o = e.value,
                            ...
                            case 36:
                                return t.router = Z = (0, R.createRouter)(I, D, K, {
                                    initialProps: M,
                                    pageLoader: Y,
                                    App: $,
                                    Component: ne,
            ...
            function se(e) {
                var t = e.App,
                    r = e.err;
                return Y.loadPage("/_error").then((function(n) {
                    var a = n.page,
                        o = n.styleSheets,
                        i = ve(t),
                        u = {
