    ...
    [2], {
                ...
                return i(t, [{
                    ...
                    value: function() {
                        var e = o(n.mark((function e(r, o, a, i, u) {
                            var l, f, v, y, b, w, P, O, j, M, D, N, U, q, W, F, G, B, H, V, z, X, Y, K, $, Q, J, Z, tt, et, rt, nt, ot, at, it;
                                ...
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 19:
                                        if (i._h || (this.isSsr = !1), h.ST && performance.mark("routeChange"), y = i.shallow, b = {
                                                shallow: void 0 !== y && y
                                            }, this._inFlightRoute && this.abortComponentLoad(this._inFlightRoute, b), a = k(_(S(a) ? E(a) : a, i.locale, this.defaultLocale)), w = x(S(a) ? E(a) : a, this.locale), this._inFlightRoute = a, i._h || !this.onlyAHashChange(w)) {
                                            e.next = 35;
                                            break
                                        }
                                        return this.asPath = w, t.events.emit("hashChangeStart", a, b), this.changeState(r, o, a, i), this.scrollToHash(w), this.notify(this.components[this.route], null), t.events.emit("hashChangeComplete", a, b), e.abrupt("return", !0);
                                    case 35:
                                        return P = (0, d.parseRelativeUrl)(o), O = P.pathname, j = P.query, e.prev = 37, e.next = 40, this.pageLoader.getPageList();
                                    case 40:
                                        return M = e.sent, e.next = 43, (0, s.getClientBuildManifest)();
                                    case 43:
                                    ...
                                    case 51:
                                        if (this.urlIsNew(w) || v || (r = "replaceState"), N = a, O = O ? (0, c.removePathTrailingSlash)(E(O)) : O, f && "/_error" !== O && (P.pathname = A(O, M), P.pathname !== O && (O = P.pathname, o = (0, h.formatWithValidation)(P))), U = (0, c.removePathTrailingSlash)(O), R(a)) {
                                            e.next = 61;
                                            break
                                        }
                                        e.next = 59;
                                    ...
                                    case 61:
                                        ...
                                        if (q = (0, d.parseRelativeUrl)(N), W = q.pathname, F = (0, g.getRouteRegex)(U), G = (0, m.getRouteMatcher)(F)(W), H = (B = U === W) ? L(U, W, j) : {}, G && (!B || H.result)) {
                                            e.next = 76;
                                            break
                                        }
                                        if (!((V = Object.keys(F.groups).filter((function(t) {
                                                return !j[t]
                                            }))).length > 0)) {
                                            e.next = 74;
                                            break
                                        }
                                        throw new Error((B ? "The provided `href` (".concat(o, ") value is missing query values (").concat(V.join(", "), ") to be interpolated properly. ") : "The provided `as` value (".concat(W, ") is incompatible with the `href` value (").concat(U, "). ")) + "Read more: https://nextjs.org/docs/messages/".concat(B ? "href-interpolation-failed" : "incompatible-href-as"));
                                    case 74:
                                        e.next = 77;
                                        break;
                                    case 76:
                                        B ? a = (0, h.formatWithValidation)(Object.assign({}, q, {
                                            pathname: H.result,
                                            query: C(j, H.params)
                                        })) : Object.assign(j, G);
                                    case 77:
                                        return t.events.emit("routeChangeStart", a, b), e.prev = 78, e.next = 81, this.getRouteInfo(U, O, j, a, N, b);
                                    case 81:
                                        if (Y = e.sent, $ = (K = Y).error, Q = K.props, J = K.__N_SSG, Z = K.__N_SSP, !J && !Z || !Q) {
                                            e.next = 108;
                                            break
                                        }
                                        ...
                                        if ((et = (0, d.parseRelativeUrl)(tt)).pathname = A(et.pathname, M), !M.includes(et.pathname)) {
                                            e.next = 92;
                                            break
                                        }
                                        return rt = I(this, tt, tt), nt = rt.url, ot = rt.as, e.abrupt("return", this.change(r, nt, ot, i));
                                    case 92:
                                        return window.location.href = tt, e.abrupt("return", new Promise((function() {})));
                                    case 94:
                                        if (this.isPreview = !!Q.__N_PREVIEW, Q.notFound !== T) {
                                            e.next = 108;
                                            break
                                        }
                                    ...
                                    case 105:
                                        return e.next = 107, this.getRouteInfo(at, at, j, a, N, {
                                            shallow: !1
                                        });
                                    case 107:
                                        Y = e.sent;
                                    case 108:
                                        return t.events.emit("beforeHistoryChange", a, b), this.changeState(r, o, a, i), it = i.shallow && this.route === U, i._h && "/_error" === O && 500 === (null == (z = self.__NEXT_DATA__.props) || null == (X = z.pageProps) ? void 0 : X.statusCode) && null != Q && Q.pageProps && (Q.pageProps.statusCode = 500), e.next = 115, this.set(U, O, j, w, Y, u || (it || !i.scroll ? null : {
                                            x: 0,
                                            y: 0
                                        })).catch((function(t) {
                                    ...
                                    case 115:
                                        ...
                                        throw t.events.emit("routeChangeError", $, w, b), $;
                                    case 118:
                                        return t.events.emit("routeChangeComplete", a, b), e.abrupt("return", !0);
                                    case 123:
                        ...
                        var e = o(n.mark((function e(r, o, a, i, u, c) {
                            ...
                            return n.wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 19:
                                        p.props = e.sent, e.next = 25;
                                        break;
                                    case 22:
                                        e.prev = 22, e.t0 = e.catch(16), p.props = {};
                                    case 25:
                                        return e.abrupt("return", p);
                                    case 28:
                                        return e.prev = 28, e.t1 = e.catch(6), e.abrupt("return", this.handleRouteInfoError(e.t1, o, a, i, u, !0));
                                    case 31:
                                    case "end":
                                        return e.stop()
                                }
        ...
        ls82: function(t, e, r) {
            var n = function(t) {
                ...
                return m.prototype = g, c(x, "constructor", g), c(g, "constructor", m), m.displayName = c(g, u, "GeneratorFunction"), t.isGeneratorFunction = function(t) {
